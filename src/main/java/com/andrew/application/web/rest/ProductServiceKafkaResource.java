...
import com.andrew.application.config.KafkaSseConsumer;
import com.andrew.application.config.KafkaSseProducer;
...
public class ProductServiceKafkaResource {
    ...
    private final Logger log = LoggerFactory.getLogger(ProductServiceKafkaResource.class);
    ...
    public ProductServiceKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
