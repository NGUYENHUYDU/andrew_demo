package com.andrew.sona.web.rest;

import static org.springframework.web.servlet.mvc.method.annotation.SseEmitter.event;

import com.andrew.sona.config.KafkaSseConsumer;
import com.andrew.sona.config.KafkaSseProducer;
...
@RestController
@RequestMapping("/api/sona-product-service-kafka")
public class SonaProductServiceKafkaResource {

    private final Logger log = LoggerFactory.getLogger(SonaProductServiceKafkaResource.class);
    ...
    public SonaProductServiceKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
